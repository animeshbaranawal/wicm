...
public class UByteLDMutationFileReader extends WICMMutationFileReader<IntWritable, UByteIntIntervalData, UByteIntIntervalData> {
    ...
    UByteIntIntervalData setVertexValue(String[] line) {
        ...
        if(getMode() == MODE.ADD_VERTEX) {
            ...
            endpoint = UnsignedByte.MAX_VALUE;
        } else {
            startpoint = 0;
            endpoint = 0;
        }

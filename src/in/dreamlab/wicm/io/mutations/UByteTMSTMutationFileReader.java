...
public class UByteTMSTMutationFileReader extends WICMMutationFileReader<IntWritable, UBytePairUByteIntIntervalData, UByteUByteIntervalData> {
    ...
    @Override
    UBytePairUByteIntIntervalData setVertexValue(String[] line) {

...
public class UByteEAT extends
        DebugUByteWindowIntervalComputation<IntWritable, Integer, UByteIntIntervalData, Integer, UByteIntIntervalData, Integer, Integer, UByteIntStartSlimMessage> {
    ...
    public Iterable<UByteIntStartSlimMessage> scatter(
        ...
        Integer reachingTime = Integer.max(earliestArrival, interval.getStart().byteValue()) + travelDuration;

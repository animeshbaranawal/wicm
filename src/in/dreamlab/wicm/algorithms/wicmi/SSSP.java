...
public class SSSP extends
        DebugIntWindowIntervalComputation<IntWritable, Double, IntDoubleIntervalData, Double, IntDoubleIntervalData, Double, Double, IntDoubleIntervalMessage> {
    ...
    @Override
    public boolean isDefault(Double vertexValue) {
        return vertexValue == Double.POSITIVE_INFINITY;
    }
}

...
public class UByteREACH_D extends
        DebugUByteWindowIntervalComputation<IntWritable, Boolean, UByteBooleanIntervalData, Boolean, UByteBooleanIntervalData, Boolean, Boolean, UByteBooleanStartSlimMessage> {

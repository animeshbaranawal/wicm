...
public class UByteTMST extends
        DebugUByteWindowIntervalComputation<IntWritable, Pair<UnsignedByte,Integer>, UBytePairUByteIntIntervalData, UnsignedByte, UByteUByteIntervalData, Pair<UnsignedByte, Integer>, Pair<UnsignedByte, Integer>, UBytePairUByteIntStartSlimMessage> {
    ...
    @Override
    public boolean isDefault(Pair<UnsignedByte, Integer> vertexValue) {
        return vertexValue.getLeft().intValue() == UnsignedByte.MAX_VALUE;
    }
}

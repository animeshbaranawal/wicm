...
public class WarpBlock {
    ...
    public WarpBlock(Operation<Integer, Integer> operation) {
    ...
    private RangeMap<Integer, Boolean> getElementaryIntervals(Iterable<IntIntIntervalMessage> messages,
        ...
        int counter = 0;
        for (IntervalMessage<Integer, Integer> msg : messages) {
            if (counter < blockStart) {
                counter++;
                continue;
            }
            if (counter == blockEnd)
    ...
    public TreeRangeMap<Integer, Pair<Integer, Integer>> warp(Iterable<IntIntIntervalMessage> messages,
                                                               TreeRangeMap<Integer, Integer> statePartitions,
                                                               IntInterval lifespan,
        ...
        RangeMap<Integer, Boolean> elementaryIntervalMap = getElementaryIntervals(messages, statePartitions,
                lifespan, useStatePartitionInterval, blockStart, blockEnd);
    ...
    public void warpBlock(Iterable<IntIntIntervalMessage> messages,
                                                    TreeRangeMap<Integer, Integer> statePartitions,
                                                    IntInterval lifespan,
                                                    int blockStart, int blockEnd,
        ...
        RangeMap<Integer, Pair<Integer, Integer>> warppedIntervals = warp(messages, statePartitions, lifespan,
                false, true, blockStart, blockEnd);

...
org.apache.giraph.GiraphRunner in.dreamlab.wicm.algorithms.wicmi.REACH_D \
--yarnjars WICM-1.0-SNAPSHOT-jar-with-dependencies.jar \
--yarnheap 1000 \
-vif in.dreamlab.wicm.io.mutations.formats.REACHDTextInputFormat -vip "$inputGraph" \
...
-ca giraph.vertexResolverClass=in.dreamlab.wicm.graph.mutations.resolver.REACHDVertexResolver \
-ca wicm.mutationReaderClass=in.dreamlab.wicm.io.mutations.REACHDMutationFileReader \

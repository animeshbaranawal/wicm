...
org.apache.giraph.GiraphRunner in.dreamlab.wicm.algorithms.wicmi.SSSP \
--yarnjars WICM-1.0-SNAPSHOT-jar-with-dependencies.jar \
--yarnheap 1000 \
-vif in.dreamlab.wicm.io.mutations.formats.SSSPTextInputFormat -vip "$inputGraph" \
...
-ca giraph.vertexResolverClass=in.dreamlab.wicm.graph.mutations.resolver.SSSPVertexResolver \
-ca wicm.mutationReaderClass=in.dreamlab.wicm.io.mutations.SSSPMutationFileReader \

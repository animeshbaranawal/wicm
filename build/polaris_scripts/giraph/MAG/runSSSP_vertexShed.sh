...
-vof in.dreamlab.graphiteOOC.io.formats.IntDoubleIdWithValueTextSuperstepOutputFormat -op $outputDir"_windowed" -w 8 \
...
-ca graphite.warpOperationClass=in.dreamlab.graphiteOOC.warpOperation.DoubleMin \

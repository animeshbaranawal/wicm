...
org.apache.giraph.GiraphRunner in.dreamlab.graphiteOOC.algorithms.Reddit.Window.EAT \
...
-vof in.dreamlab.graphiteOOC.io.formats.IntIntIdWithValueTextSuperstepOutputFormat -op $outputDir"_windowed" -w 8 \
...
org.apache.giraph.GiraphRunner in.dreamlab.graphiteOOC.algorithms.Reddit.Debug.EAT \

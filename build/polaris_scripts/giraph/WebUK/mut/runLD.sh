...
--yarnheap 200 \
-vif in.dreamlab.wicm.io.mutations.formats.UByteLDTextInputFormat -vip $inputGraph \
...
-ca giraph.vertexResolverClass=in.dreamlab.wicm.graph.mutations.resolver.UByteLDVertexResolver \
-ca wicm.mutationReaderClass=in.dreamlab.wicm.io.mutations.UByteLDMutationFileReader \
...
#echo $appID
#yarn logs -applicationId $appID > "LD_"$outputDir"_"$source"_mut.log"

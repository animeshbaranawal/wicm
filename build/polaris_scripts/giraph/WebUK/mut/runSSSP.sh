...
org.apache.giraph.GiraphRunner in.dreamlab.wicm.algorithms.wicm.UByteSSSP \
--yarnjars WICM-1.0-SNAPSHOT-jar-with-dependencies.jar \
--yarnheap 200 \
-vif in.dreamlab.wicm.io.mutations.formats.UByteSSSPTextInputFormat -vip $inputGraph \
-vof in.dreamlab.wicm.io.formats.VarIntUByteIntIdWithValueTextOutputFormat -op $outputDir"_mut" -w 1 \
...
-ca giraph.vertexResolverClass=in.dreamlab.wicm.graph.mutations.resolver.UByteSSSPVertexResolver \
-ca wicm.mutationReaderClass=in.dreamlab.wicm.io.mutations.UByteSSSPMutationFileReader \
...
#echo $appID
#yarn logs -applicationId $appID > "SSSP_"$outputDir"_"$source"_mut.log"

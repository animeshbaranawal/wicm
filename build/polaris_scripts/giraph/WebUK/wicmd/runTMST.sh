...
org.apache.giraph.GiraphRunner in.dreamlab.wicm.algorithms.wicm.UByteTMST \
...
-vof in.dreamlab.wicm.io.formats.UBytePairUByteIntIdWithValueTextOutputFormat -op $outputDir"_windowed" -w 8 \

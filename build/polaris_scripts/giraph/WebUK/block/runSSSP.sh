...
org.apache.giraph.GiraphRunner in.dreamlab.wicm.algorithms.block_icm.UByteSSSP \
--yarnjars WICM-1.0-SNAPSHOT-jar-with-dependencies.jar \
--yarnheap 60000 \
-vif in.dreamlab.wicm.io.formats.VarIntUByteIntNullTextInputFormat -vip $inputGraph \
-vof in.dreamlab.wicm.io.formats.VarIntUByteIntIdWithValueTextOutputFormat -op $outputDir"_debug" -w 8 \

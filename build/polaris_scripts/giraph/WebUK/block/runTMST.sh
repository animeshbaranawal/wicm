...
org.apache.giraph.GiraphRunner in.dreamlab.wicm.algorithms.block_icm.UByteTMST \
--yarnjars WICM-1.0-SNAPSHOT-jar-with-dependencies.jar \
--yarnheap 60000 \
-vif in.dreamlab.wicm.io.formats.UBytePairUByteIntNullTextInputFormat -vip $inputGraph \
-vof in.dreamlab.wicm.io.formats.UBytePairUByteIntIdWithValueTextOutputFormat -op $outputDir"_debug" -w 8 \
-ca giraph.vertexClass=in.dreamlab.graphite.graph.DefaultIntervalVertex \
-ca giraph.vertexValueClass=in.dreamlab.wicm.graphData.UBytePairUByteIntIntervalData \
-ca giraph.edgeValueClass=in.dreamlab.wicm.graphData.UByteUByteIntervalData \
-ca giraph.outgoingMessageValueClass=in.dreamlab.wicm.comm.messages.UBytePairUByteIntStartSlimMessage \
-ca graphite.intervalClass=in.dreamlab.wicm.types.UByteInterval \
-ca graphite.warpOperationClass=in.dreamlab.wicm.warpOperation.UByteTMSTOperator \

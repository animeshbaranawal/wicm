...
org.apache.giraph.GiraphRunner in.dreamlab.graphiteOOC.algorithms.Reddit.Window.FASTv4Byte \
--yarnjars FASTv4.jar \
--yarnheap 60000 \
-vif in.dreamlab.graphiteOOC.io.formats.UBytePairIntBooleanTextInputFormat -vip $inputGraph \
-vof in.dreamlab.graphiteOOC.io.formats.UBytePairIntBooleanFASTTextOutputFormat -op $outputDir"_windowed" -w 8 \
-ca giraph.vertexClass=in.dreamlab.graphite.graph.DefaultIntervalVertex \
-ca giraph.vertexValueClass=in.dreamlab.graphite.graphData.UBytePairIntBooleanIntervalData \
-ca giraph.edgeValueClass=in.dreamlab.graphite.graphData.UByteUByteIntervalData \
-ca giraph.outgoingMessageValueClass=in.dreamlab.graphite.comm.messages.UBytePairIntBooleanIntervalMessage \
...
### default
hadoop jar FASTv4.jar \
org.apache.giraph.GiraphRunner in.dreamlab.graphiteOOC.algorithms.Reddit.Debug.FASTv4Byte \
--yarnjars FASTv4.jar \
--yarnheap 60000 \
-vif in.dreamlab.graphiteOOC.io.formats.UBytePairIntBooleanTextInputFormat -vip $inputGraph \
-vof in.dreamlab.graphiteOOC.io.formats.UBytePairIntBooleanFASTTextOutputFormat -op $outputDir"_debug" -w 8 \
-ca giraph.vertexClass=in.dreamlab.graphite.graph.DefaultIntervalVertex \
-ca giraph.vertexValueClass=in.dreamlab.graphite.graphData.UBytePairIntBooleanIntervalData \
-ca giraph.edgeValueClass=in.dreamlab.graphite.graphData.UByteUByteIntervalData \
-ca giraph.outgoingMessageValueClass=in.dreamlab.graphite.comm.messages.UBytePairIntBooleanIntervalMessage \

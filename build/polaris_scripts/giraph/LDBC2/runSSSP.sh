...
org.apache.giraph.GiraphRunner in.dreamlab.graphiteOOC.algorithms.Reddit.Window.SSSPByte \
--yarnjars giraph-1.3.0-SNAPSHOT-for-hadoop-3.1.1-jar-with-dependencies.jar \
--yarnheap 60000 \
-vif in.dreamlab.graphite.io.formats.VarIntUByteIntNullTextInputFormat -vip $inputGraph \
-vof in.dreamlab.graphite.io.formats.VarIntUByteIntIdWithValueTextOutputFormat -op $outputDir"_windowed" -w 8 \
...
-ca giraph.outgoingMessageValueClass=in.dreamlab.graphite.comm.messages.UByteIntStartSlimMessage \
...
### default
hadoop jar giraph-1.3.0-SNAPSHOT-for-hadoop-3.1.1-jar-with-dependencies.jar \
org.apache.giraph.GiraphRunner in.dreamlab.graphiteOOC.algorithms.Reddit.Debug.SSSPByte \
--yarnjars giraph-1.3.0-SNAPSHOT-for-hadoop-3.1.1-jar-with-dependencies.jar \
--yarnheap 60000 \
-vif in.dreamlab.graphite.io.formats.VarIntUByteIntNullTextInputFormat -vip $inputGraph \
-vof in.dreamlab.graphite.io.formats.VarIntUByteIntIdWithValueTextOutputFormat -op $outputDir"_debug" -w 8 \
-ca giraph.vertexClass=in.dreamlab.graphite.graph.DefaultIntervalVertex \
-ca giraph.vertexValueClass=in.dreamlab.graphite.graphData.UByteIntIntervalData \
-ca giraph.edgeValueClass=in.dreamlab.graphite.graphData.UByteIntIntervalData \
-ca giraph.outgoingMessageValueClass=in.dreamlab.graphite.comm.messages.UByteIntStartSlimMessage \

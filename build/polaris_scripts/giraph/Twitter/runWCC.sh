...
--yarnheap 60000 \
-vif in.dreamlab.graphite.io.formats.VarIntUByteVarIntNullTextInputFormat -vip $inputGraph \
-vof in.dreamlab.graphite.io.formats.VarIntUByteVarIntIdWithValueTextOutputFormat -op $outputDir"_windowed" -w 10 \
-ca giraph.vertexClass=in.dreamlab.graphite.graph.DefaultIntervalVertex \
-ca giraph.vertexValueClass=in.dreamlab.graphite.graphData.UByteVarIntIntervalData \
-ca giraph.edgeValueClass=in.dreamlab.graphite.graphData.UByteVarIntIntervalData \
-ca giraph.partitionClass=org.apache.giraph.partition.ByteArrayPartition \
-ca giraph.outgoingMessageValueClass=in.dreamlab.graphite.comm.messages.UByteVarIntIntervalMessage \
-ca graphite.intervalClass=in.dreamlab.graphite.types.UByteInterval \
-ca graphite.warpOperationClass=in.dreamlab.graphite.warpOperation.VarIntMin \
...
--yarnheap 60000 \
-vif in.dreamlab.graphite.io.formats.VarIntUByteVarIntNullTextInputFormat -vip $inputGraph \
-vof in.dreamlab.graphite.io.formats.VarIntUByteVarIntIdWithValueTextOutputFormat -op $outputDir"_debug" -w 10 \
-ca giraph.vertexClass=in.dreamlab.graphite.graph.DefaultIntervalVertex \
-ca giraph.vertexValueClass=in.dreamlab.graphite.graphData.UByteVarIntIntervalData \
-ca giraph.edgeValueClass=in.dreamlab.graphite.graphData.UByteVarIntIntervalData \
-ca giraph.outgoingMessageValueClass=in.dreamlab.graphite.comm.messages.UByteVarIntIntervalMessage \

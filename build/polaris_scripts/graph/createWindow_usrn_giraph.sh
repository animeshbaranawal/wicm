...
org.apache.giraph.GiraphRunner in.dreamlab.graphiteOOC.Utilities.NoOp_double \
--yarnjars giraph-1.3.0-SNAPSHOT-for-hadoop-3.1.1-jar-with-dependencies.jar \
--yarnheap 60000 \
-vif in.dreamlab.graphiteOOC.io.formats.JsonIntIntVIntEDoubleIntervalVertexInputFormat -vip $inputGraph \
-vof in.dreamlab.graphiteOOC.OOC.WindowJsonIntIntVIntEDoubleIntervalVertexOutputFormat -op $outputDir"_windows" -w 8 \

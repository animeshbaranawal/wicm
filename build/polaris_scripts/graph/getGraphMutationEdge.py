...
if __name__ == "__main__":
    ...
    graph_windows = [i for i in range(0, 41)]
    ...
    # dummy = sc.parallelize([(((graph_num_windows-1)*graph_workers, -1), (36, 0))])  # for reverse
